...
class Armor(metaclass=Metaclass_Armor):
    ...
    def __init__(self, **kwargs):
        ...
        self.fit_yaw = kwargs.get('fit_yaw', float())
        from geometry_msgs.msg import Pose
    ...
    @builtins.property
    def fit_yaw(self):
        """Message field 'fit_yaw'."""
        return self._fit_yaw
    ...
    def fit_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'fit_yaw' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'fit_yaw' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._fit_yaw = value
