...
{
public:
  explicit Init_Target_type(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_armors_num type(::auto_aim_interfaces::msg::Target::_type_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_type id(::auto_aim_interfaces::msg::Target::_id_type arg)
  {
    msg_.id = std::move(arg);
    return Init_Target_type(msg_);
  }
