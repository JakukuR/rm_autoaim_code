...
class Init_Armor_fit_yaw
{
public:
  explicit Init_Armor_fit_yaw(::auto_aim_interfaces::msg::Armor & msg)
  : msg_(msg)
  {}
  Init_Armor_pose fit_yaw(::auto_aim_interfaces::msg::Armor::_fit_yaw_type arg)
  {
    msg_.fit_yaw = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Armor_fit_yaw distance_to_image_center(::auto_aim_interfaces::msg::Armor::_distance_to_image_center_type arg)
  {
    msg_.distance_to_image_center = std::move(arg);
    return Init_Armor_fit_yaw(msg_);
  }
